...
namespace HAPISPACE {
	...
	struct Transform
	{
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		bool IsRotated() const noexcept { return rotation != 0; }
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		bool IsScaled() const noexcept { return (scale.x != 1.0f || scale.y != 1.0f); }
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		void Translate(const VectorF &trans) noexcept { position += trans; }
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		void Rotate(float radians) noexcept { rotation += radians; }
	};
